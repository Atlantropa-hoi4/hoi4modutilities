...
const table: Partial<typeof __table> = {
    ...
    "characterpreview.charactercount": "{0} 个角色",
    "characterpreview.corpscommanders": "将军",
    "characterpreview.cost": "花费 {0}",
    "characterpreview.countryleaders": "国家领导人",
    "characterpreview.expandtraits": "展开特质",
    "characterpreview.expire": "到期时间 {0}",
    "characterpreview.fieldmarshals": "元帅",
    "characterpreview.filterall": "（所有角色）",
    "characterpreview.filterconditions": "有条件",
    "characterpreview.filtermultirole": "拥有多个职位",
    "characterpreview.filternoportrait": "未找到肖像",
    ...
    "characterpreview.ledger": "类别：{0}",
    "characterpreview.legacyid": "旧版 ID {0}",
    "characterpreview.navyleaders": "海军将领",
    "characterpreview.nocharacters": "没有可显示的角色。",
    "characterpreview.nomatches": "无匹配项",
    "characterpreview.norole": "无职位",
    "characterpreview.notraits": "无特质",
    "characterpreview.notremovable": "不可撤换",
    "characterpreview.nuclearscientists": "核科学家",
    "characterpreview.operatives": "特工",
    "characterpreview.portraitmissing": "未找到肖像：{0}",
    "characterpreview.removalcost": "撤换花费 {0}",
    ...
    "characterpreview.traitnodetail": "此特质没有预览可读取的效果",
    "characterpreview.unknowntrait": "没有特质文件定义 {0}",
    "characterpreview.visible": "显示条件",
    "event.closeDetails": "关闭详情",
    "event.details": "详情",
    "event.noAiChance": "未指定 AI 选项权重。",
    "event.originalRecipient": "仅最初接收国：{0}",
    "focustree.continuousFocuses": "持续国策",
    "index.building": "正在构建",
    "index.cancelled": "索引构建已取消。",
    "index.checking": "正在检查缓存",
    "index.chooseCancel": "选择要取消的索引构建",
    "index.events": "正在构建事件索引...",
    "index.none": "当前没有正在构建的索引。",
    "index.saving": "正在保存缓存",
    "miopreview.showIncludedTraits": "显示继承的特质",
    "miopreview.showGrid": "显示网格",
    "miopreview.showOverlaps": "显示重叠的特质",
    "miopreview.gridlimit": "x = 9 边界",
    "combobox.all": "（全部）",
    ...
    "hours": "小时",
    "infile": "在文件 {0} 中：\n",
    "installpathsetto": "Hearts of Iron IV 安装路径已设置为：{0}。",
    "loading": "加载中……",
    ...
    "technology.country": "国家",
    "technology.generic": "通用",
    "technology.longName": "装备全称",
    "technology.nameMode": "科技标签",
    "technology.shortName": "装备简称",
    "technology.techName": "科技名称",
    ...
    "worldmap.warnings.onepixelprovince": "在 {0}, {1} 发现单像素省份颜色。",
    "worldmap.warnings.provincetoosmall": "该省份在 (x={1},y={2}) 附近只有 {0} 个像素，至少应有 {3} 个。",
