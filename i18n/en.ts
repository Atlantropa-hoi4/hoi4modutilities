...
const internalTable = /* SOT Do not remove this comment */{
    ...
    "event.closeDetails": "Close details",
    "event.details": "Details",
    "event.noAiChance": "No explicit AI choice weight.",
    "event.originalRecipient": "Original recipient only: {0}",
    "focustree.continuousFocuses": "Continuous focuses",
    "index.building": "Building",
    "index.cancelled": "Index build cancelled.",
    "index.checking": "Checking cache",
    "index.chooseCancel": "Choose an index build to cancel",
    "index.events": "Building event index...",
    "index.none": "No index build is running.",
    "index.saving": "Saving cache",
    "miopreview.showIncludedTraits": "Show included traits",
    "miopreview.showGrid": "Show grid",
    "miopreview.showOverlaps": "Show overlapping traits",
    "miopreview.gridlimit": "x = 9 limit",
    "combobox.all": "(All)",
    ...
    "hours": "hour(s)",
    "infile": "In file {0}:\n",
    "installpathsetto": "Install path of Hearts of Iron IV is set to: {0}.",
    "loading": "Loading...",
    ...
    "technology.country": "Country",
    "technology.generic": "Generic",
    "technology.longName": "Full equipment name",
    "technology.nameMode": "Technology label",
    "technology.shortName": "Short equipment name",
    "technology.techName": "Technology name",
