...
import type { CharacterTrait, TraitSource } from "../../src/util/characterTraits";
...
modules._load = function(request, parent, isMain) {
    if (parent?.filename.endsWith('characterTraits.js') && (request === './fileloader' || request === './debug')) {
        return {};
    }
    return originalLoad.call(this, request, parent, isMain);
};
const { readTraitFile } = require('../../src/util/characterTraits') as typeof import('../../src/util/characterTraits');
